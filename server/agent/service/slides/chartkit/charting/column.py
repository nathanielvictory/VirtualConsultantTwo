...
@register(ChartKind.COLUMN)
def render_column(*, backend: SheetsBackend, title: str, sheet_name: str, grid: Grid,
    ...
    start_row = 0  # include header row; headerCount tells Sheets it's a header
